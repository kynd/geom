...
Because this repository serves multiple purposes—ranging from text to specialized audio assets—different components are licensed under distinct terms to balance proper creative attribution, public access, and open copyleft protections.
...
All written text, explanations, articles, and documentation, along with all accompanying creative code examples, interactive sketches, and shader code (GLSL), are licensed under the **[Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)](https://creativecommons.org/licenses/by-sa/4.0/)** license.

* **What this means:** You are free to share, copy, remix, transform, and build upon both the code and text for any purpose, even commercially. However, if you modify, adapt, or build upon this material, you **must** distribute your contributions under the exact same CC BY-SA 4.0 license.
