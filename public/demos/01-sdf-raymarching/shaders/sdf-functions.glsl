...
// ---- Octahedron (fast bound, approximate) ----
...
// ---- Ellipsoid (approximate lower bound) ----
...
// ---- Triangular Prism (approximate lower bound) ----
