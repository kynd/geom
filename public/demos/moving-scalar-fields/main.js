...
const SHAPES = [
  { name: '1. Traveling radial damped cosine',  eq: 'y = e⁻ʳ cos(5r − 2t)' },
  { name: '2. Pulsing torus',                   eq: '(√(x²+z²) − R(t))² + y² = r_t(θ,t)²' },
  { name: '3. Traveling sinusoidal surface',    eq: 'y = sin(2x+t) cos(2z+0.7t)' },
  { name: '4. Oscillating spheroid',            eq: '|p| = r₀ + A(t)·P₂(cosθ)' },
  { name: '5. Pulsing saddle',                  eq: 'y = A(t)(x² − z²)' },
  { name: '6. Pulsing gyroid',                  eq: 'cos(k(t)x)sin(k(t)y) + … = 0' },
  { name: '7. Oscillating Schwartz P',          eq: 'cos 2x + cos 2y + cos 2z = c(t)' },
  { name: '8. Pulsing lemniscate',              eq: '(x²+y²+z²)² = a(t)²(x²−z²)' },
  { name: '9. Tilting ellipsoid',               eq: 'x²/a² + y²/b² + z²/c² = 1, axis tilts' },
  { name: '10. Pulsing tanglecube',             eq: 'x⁴−5x² + y⁴−5y² + z⁴−5z² + c(t) = 0' },
  { name: '11. Pulsing Chmutov T₄',            eq: 'T₄(sx) + T₄(sy) + T₄(sz) = 0, s(t)' },
  { name: '12. Traveling sinusoidal cone',      eq: 'x²+z² = (y + A sin(4y−t))²' },
  { name: '13. Pulsing Gaussian',               eq: 'y = A(t) e^(−r²/σ(t)²)' },
  { name: '14. Oscillating Schoen I-WP',        eq: 'cos 2x cos 2y + cos 2y cos 2z + cos 2z cos 2x = c(t)' },
  { name: '15. Tilting saddle',                 eq: 'y = x² − z² + A(t)·xz' },
  { name: '16. Rotating torus',                 eq: 'tube r = r₀ + ε sin(4θ − t)' },
  { name: '17. Rotating harmonic sphere',       eq: '|p| = 1 + A sin(3λ−t) sin(2φ)' },
  { name: '18. Traveling hyperboloid',          eq: 'x²+z² − y² + A sin(4y−t) = c' },
  { name: '19. Pulsing cyclic cubic',           eq: 'x²y + y²z + z²x = A(t)' },
  { name: '20. Rotating paraboloid',            eq: 'y = sin(t)x² + cos(t+φ)z²' },
];
