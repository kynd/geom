...
const FPS      = 60;
const FFT_BINS = 256;   // keep 256 so shaders need no changes; 128 Mel bins interpolated up
const HIST     = 256;
...
// wavBuf: no raw waveform in pre-computed data; fill with 128 (unsigned silence)
...
function updateFromPrecomputed(frame, uniforms, textures) {
  const mel = frame.fftL;  // 128 Mel bins

  // Stretch 128 Mel bins → 256 FFT texture slots (linear interpolation)
