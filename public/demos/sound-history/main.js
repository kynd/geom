...
async function init() {
  ...
  const sharedUniforms = {
    ...
    u_sssStr:     { value: 0.3 },
    u_deformP1:      { value: 1.0  },
    u_deformP2:      { value: 0.55 },
    u_histDuration:  { value: 0.5  },
  ...
  const movingUniforms   = { ...sharedUniforms, u_surfaceIndex: { value: 15 } };
  ...
  shapeSel.value = '14';  // Tilting saddle
  ...
  soundSel.value = 'bass';
  composer.render();
  loadSound(SOUND_FILES.find(x => x.value === 'bass'));
}
