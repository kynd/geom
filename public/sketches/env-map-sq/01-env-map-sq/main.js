...
async function init() {
  ...
  const [
    ...
    fetch('../../../demos/env-map/shaders/fragment-sdf.glsl').then(r => r.text()),
    fetch('../../../demos/env-map/shaders/fragment-scalar.glsl').then(r => r.text()),
    fetch('../../../demos/env-map/shaders/fragment-platonic.glsl').then(r => r.text()),
    fetch('../../../demos/env-map/shaders/fragment-moving-scalar.glsl').then(r => r.text()),
    fetch('../../../demos/env-map/shaders/vertex.glsl').then(r => r.text()),
  ]);
