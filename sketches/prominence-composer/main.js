...
import { buildEnvMapTexture } from '/public/js/oklch-envmap.js';
...
const SOUND_BASE  = '/public/sound/full/';
const FPS         = 60;
const HIST        = 256;
...
async function init() {
  ...
  const [
    ...
    fetch('/public/demos/sound-shapes/shaders/fragment-sdf.glsl').then(r=>r.text()),
    fetch('/public/demos/sound-shapes/shaders/fragment-platonic.glsl').then(r=>r.text()),
    fetch('/public/demos/sound-shapes/shaders/fragment-scalar.glsl').then(r=>r.text()),
    fetch('/public/demos/sound-shapes/shaders/fragment-moving.glsl').then(r=>r.text()),
    fetch('/public/demos/sound-shapes/shaders/vertex.glsl').then(r=>r.text()),
    fetch('/public/shaders/sdf-functions.glsl').then(r=>r.text()),
    fetch('/public/shaders/sdf-marcher.glsl').then(r=>r.text()),
    fetch('/public/shaders/scalar-marcher.glsl').then(r=>r.text()),
    fetch('/public/shaders/platonic-functions.glsl').then(r=>r.text()),
    fetch('/public/shaders/moving-scalar-functions.glsl').then(r=>r.text()),
    fetch('/public/shaders/rim-lighting.glsl').then(r=>r.text()),
    fetch('/public/demos/sound-shapes/shaders/deform.glsl').then(r=>r.text()),
    fetch('/public/demos/sound-fill/shaders/fragment.glsl').then(r=>r.text()),
    fetch('/public/demos/sound-form/shaders/fragment.glsl').then(r=>r.text()),
  ]);
  ...
  window.addEventListener('mousemove', e => {
    ...
    camPhi = Math.max(-1.4, Math.min(1.4, camPhi - (e.clientY - lastMY) * 0.005));
